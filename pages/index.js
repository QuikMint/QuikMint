    ...
    <main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-10 lg:px-8 xl:mt-14 mb-60'>
      ...
      <div className='sm:text-center lg:text-left'>
        ...
        <p className='mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0'>
          With our services, you can take card payments for crypto assets, bridging the gap between
          blockchain and centralized finance. Take your NFT collection to the next level with
          QuikMint.
        </p>
